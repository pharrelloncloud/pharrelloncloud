...
- 🔒 **Security & Networking**: CompTIA (Network+, Security+) | Cisco CCNA (studying)
...
- ✅ AWS Cloud Practitioner *(target: Dec 2025)*
...
<!--
**pharrelloncloud/pharrelloncloud** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
